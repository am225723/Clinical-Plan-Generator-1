...
"[project]/pages/api/upload-logo.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        const { data: signedData, error: signedError } = await supabaseAdmin.storage.from('logos').createSignedUploadUrl(filePath);
        if (signedError) {
            throw signedError;
        }
        const { data: publicData } = supabaseAdmin.storage.from('logos').getPublicUrl(filePath);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__23470745._.js.map